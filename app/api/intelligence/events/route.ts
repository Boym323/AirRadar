...
export async function GET(request: Request): Promise<Response> {
  ...
  const allowed = new Set(["APPROACH", "LANDING", "TAKEOFF", "GO_AROUND", "HOLDING", "DIVERSION", "TOP_OF_DESCENT", "AIRSPACE_ENTRY", "AIRSPACE_EXIT"]); const type = url.searchParams.get("type");
