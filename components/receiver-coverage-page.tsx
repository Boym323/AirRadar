...
export default function ReceiverCoveragePage() {
  ...
  return <main className="history-page statistics-page">
    <header className="history-page-header statistics-page-header"><div><h1>Receiver coverage analytics</h1><p className="statistics-subtitle">Network-reference capture ratio · not antenna efficiency or message reception rate</p></div><nav className="statistics-nav"><Link className="back-link" href="/statistics">Statistics</Link><Link className="back-link" href="/">Radar</Link></nav></header>
