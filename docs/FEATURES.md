...
| `/aircraft/:hex` | Durable aircraft metadata, recent flight instances, 7/30-day summary, lifetime Flight-instance statistics, NEW status, and optional photo. | Production; PostgreSQL required for durable detail, photo optional. |
