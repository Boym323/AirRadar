...
| `/flights/:id` | Standalone captured-flight detail with aircraft and airport links, observed sampled trail, and bounded playback. | Production with PostgreSQL history. |
