  ...
  async headers() {
    return [{
      ...
      headers: [
        ...
        { key: "Content-Security-Policy", value: "default-src 'self'; base-uri 'self'; object-src 'none'; frame-ancestors 'none'; form-action 'self'; script-src 'self' 'unsafe-inline'; style-src 'self' 'unsafe-inline'; img-src 'self' data: blob: https://tile.openstreetmap.org https://t.plnspttrs.net https://www.planespotters.net; connect-src 'self' data: https://tile.openstreetmap.org; worker-src 'self' blob:; child-src blob:; font-src 'self' data:;" },
      ],
    }];
  },
};
